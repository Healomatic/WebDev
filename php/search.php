	...
	echo'<a href="form.php">Formulaire</a></br></br>
		<form action="search.php" methode="post" enctype="multipart/form-data">
			<div class="recherche">Recherche</br></br>
					Prenom:<input type="text" name="rechpre" id="rechpre" />
		...
		if (isset($_POST['rechpre'])){ 
		$rechpre=$_POST['rechpre'];
		echo $rechpre;
		$reponse = $bdd->query('SELECT * FROM data WHERE Prenom="'.$rechpre.'" ORDER BY Nom');
		...
		while ($donnees = $reponse->fetch()){
			...
			echo'<td align="center"><a href="https://openclassrooms.com">Modifier</a></td></tr>';
		}
			echo'</tbody>
				</table>';
	$reponse->closeCursor(); // Termine le traitement de la requête
	}else{echo'<p style="font-size:82;color:red;">Remplissez au moins un champ de recherche !</p>';}
	echo'</body>
	</html>';}
